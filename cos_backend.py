...
class COSBackend:
    ...
    def __init__(self, cos_config):
        service_endpoint = cos_config['ibm_cos']['endpoint']
        secret_key = cos_config['ibm_cos']['secret_key']
        access_key = cos_config['ibm_cos']['access_key']
    ...
    def list_objects (self, bucket_name, prefix=None):
        paginator = self.cos.client.get_paginator('list_objects_v2')
        try: 
